import"../chunks/Bzak7iHL.js";import{I,J as bt,R as it,aS as Ft,H as wt,N as Pt,O as It,aT as qt,M as Ot,T as Nt,a9 as zt,a8 as yt,a4 as xt,x as Ut,ae as Lt,ad as Jt,Q as Gt,V as A,X as p,ai as x,Z as b,_,am as D,al as S,ao as Vt,W as R,n as d,an as q,U as K,u as $,Y as tt,F as vt,v as P,ak as O,az as Qt,aU as Yt,r as Zt}from"../chunks/BMv0M8sc.js";import{i as Ht,a as j,d as Wt}from"../chunks/B-PFOxWu.js";import{e as Q,i as Y,b as Xt,s as $t,c as Kt,d as te}from"../chunks/Kj4hIjr3.js";import{c as ut,b as ee,i as V}from"../chunks/DFRHLSQ6.js";import{s as mt,p as w}from"../chunks/PmbK7F7n.js";import{s as At}from"../chunks/D0W2oKZF.js";import{h as Ct,c as ae}from"../chunks/fMeCNWI5.js";import{b as ne}from"../chunks/B9OH0qW3.js";function pt(e,t,o,n,s,c){let v=I;I&&bt();var m,h,r=null;I&&it.nodeType===Ft&&(r=it,bt());var u=I?it:e,a;wt(()=>{const i=t()||null;var C=i==="svg"?qt:null;i!==m&&(a&&(i===null?Lt(a,()=>{a=null,h=null}):i===h?Jt(a):Gt(a)),i&&i!==h&&(a=It(()=>{if(r=I?r:C?document.createElementNS(C,i):document.createElement(i),Ot(r,r),n){I&&Ht(i)&&r.append(document.createComment(""));var f=I?Nt(r):r.appendChild(zt());I&&(f===null?yt(!1):xt(f)),n(r,f)}Ut.nodes_end=r,u.before(r)})),m=i,m&&(h=m))},Pt),v&&(yt(!0),xt(u))}var kt={},dt={},ct=34,X=10,lt=13;function St(e){return new Function("d","return {"+e.map(function(t,o){return JSON.stringify(t)+": d["+o+'] || ""'}).join(",")+"}")}function oe(e,t){var o=St(e);return function(n,s){return t(o(n),s,e)}}function Tt(e){var t=Object.create(null),o=[];return e.forEach(function(n){for(var s in n)s in t||o.push(t[s]=s)}),o}function M(e,t){var o=e+"",n=o.length;return n<t?new Array(t-n+1).join(0)+o:o}function re(e){return e<0?"-"+M(-e,6):e>9999?"+"+M(e,6):M(e,4)}function se(e){var t=e.getUTCHours(),o=e.getUTCMinutes(),n=e.getUTCSeconds(),s=e.getUTCMilliseconds();return isNaN(e)?"Invalid Date":re(e.getUTCFullYear())+"-"+M(e.getUTCMonth()+1,2)+"-"+M(e.getUTCDate(),2)+(s?"T"+M(t,2)+":"+M(o,2)+":"+M(n,2)+"."+M(s,3)+"Z":n?"T"+M(t,2)+":"+M(o,2)+":"+M(n,2)+"Z":o||t?"T"+M(t,2)+":"+M(o,2)+"Z":"")}function ie(e){var t=new RegExp('["'+e+`
...
}`;var Me=A("<p><!></p>"),De=A("<section><!></section>");function je(e,t){K(t,!0);let o=w(t,"components",19,()=>({})),n=w(t,"body",19,()=>[]);var s=D(),c=S(s);Q(c,17,n,Y,(v,m)=>{let h=()=>d(m).section,r=()=>d(m).content;const u=q(()=>h().toLowerCase().replace(/[^a-z0-9]/g,"")),a=q(()=>o()[h()]);var i=De(),C=b(i);{var f=y=>{var g=D(),k=S(g);ut(k,()=>d(a),(T,B)=>{B(T,mt(r))}),p(y,g)},l=y=>{var g=D(),k=S(g);Q(k,17,r,Y,(T,B,N,z)=>{let F=()=>d(B).type,E=()=>d(B).value;const Z=q(()=>o()[F()]),et=q(()=>typeof E()=="string");var ft=D(),Et=S(ft);{var Mt=U=>{var H=D(),at=S(H);ut(at,()=>d(Z),(nt,ot)=>{ot(nt,mt(E))}),p(U,H)},Dt=U=>{var H=D(),at=S(H);{var nt=L=>{var J=Me(),rt=b(J);Ct(rt,E),_(J),p(L,J)},ot=L=>{var J=D(),rt=S(J);{var jt=G=>{var W=D(),st=S(W);pt(st,F,!1,(gt,ht)=>{var _t=D(),Bt=S(_t);Ct(Bt,E),p(ht,_t)}),p(G,W)},Rt=G=>{var W=D(),st=S(W);pt(st,F,!1,(gt,ht)=>{Kt(gt,()=>({...E()}))}),p(G,W)};V(rt,G=>{d(et)?G(jt):G(Rt,!1)},!0)}p(L,J)};V(at,L=>{F()==="text"?L(nt):L(ot,!1)},!0)}p(U,H)};V(Et,U=>{d(Z)?U(Mt):U(Dt,!1)})}p(T,ft)}),p(y,g)};V(C,y=>{d(a)?y(f):y(l,!1)})}_(i),R(()=>$t(i,"id",d(u))),p(v,i)}),p(e,s),tt()}var Re=A('<p> </p> <progress max="100"></progress>',1);function Be(e,t){let o=w(t,"label",3,"A"),n=w(t,"value",3,0);var s=Re(),c=S(s),v=b(c,!0);_(c);var m=x(c,2);R(()=>{j(v,o()),te(m,n())}),p(e,s)}var Fe=A('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function we(e,t){K(t,!0);const{body:o}=ae,n={Test:Be};var s=Fe(),c=x(b(s),2),v=b(c),m=b(v,!0);_(v),_(c);var h=x(c,2);je(h,{get components(){return n},get body(){return o}}),_(s),R(r=>j(m,r),[()=>Ee.replace(/\t/g," ")]),p(e,s),tt()}const Pe=(e,t=vt)=>{var o=Ie(),n=b(o),s=b(n,!0);_(n);var c=x(n,2),v=b(c,!0);_(c),_(o),R(()=>{j(s,t().name),j(v,t().age)}),p(e,o)};var Ie=A('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),qe=(e,t)=>Yt(t),Oe=(e,t)=>t.random(Math.floor(Math.random()*10)),Ne=A('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function ze(e,t){K(t,!0),w(t,"age",3,30);const o=[{name:"John",age:30},{name:"Jill",age:45}];let n=O(0),s=q(()=>d(n)*2),c=q(()=>d(n)*2),v=O(0);$(()=>{P(v,d(n)*2)});var m=Ne(),h=x(S(m),4);h.__click=[qe,n];var r=x(h,2),u=b(r);_(r);var a=x(r,2),i=b(a);_(a);var C=x(a,2),f=b(C);_(C);var l=x(C,4),y=b(l);At(y,()=>t.children??vt),_(l);var g=x(l,4);g.__click=[Oe,t];var k=x(g,4);Q(k,21,()=>o,Y,(T,B)=>{Pe(T,()=>d(B))}),_(k),R(()=>{j(u,`${d(n)??""} doubled is ${d(s)??""} (derived)`),j(i,`${d(n)??""} doubled is ${d(c)??""} (derived by)`),j(f,`${d(n)??""} doubled is ${d(v)??""} ($effect)`)}),p(e,m),tt()}Wt(["click"]);const Ue=(e,t)=>{let o=O(Zt(e)),n=O(null),s=O(!0),c=O(void 0);const v=(r=!0)=>{P(s,r,!0),r===!0&&(P(c,null),P(n,null))},m=async()=>{try{const r=await fetch(d(o),t);if(!r.ok)throw new Error(`Unexpected error occurred (status ${r.status})`);let u;if(d(o).includes(".csv")){const a=await r.text();u=ce(a)}else u=await r.json();return[null,u]}catch(r){const{errorMessage:u="Unexpected error eccurred"}=r;return[u,null]}},h=async r=>{v(!0);const[u,a]=await m();if(r===d(o)){if(u){v(!1),P(c,u,!0);return}v(!1),P(n,a,!0)}};return $(()=>{h(d(o))}),{get data(){return d(n)},get loading(){return d(s)},get error(){return d(c)},get url(){return d(o)},set url(r){d(o)!==r&&P(o,r,!0)}}};var Le=A("<p>loading data...</p>"),Je=A("<p> </p>"),Ge=A("<p>data loaded</p> <pre> </pre>",1),Ve=A('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Qe(e,t){K(t,!0);const o=`${ne}/assets/demo/test.csv`,n=Ue(o);$(()=>{});var s=Ve(),c=x(b(s),2),v=b(c);{var m=r=>{var u=Le();p(r,u)},h=r=>{var u=D(),a=S(u);{var i=f=>{var l=Je(),y=b(l);_(l),R(()=>j(y,`error: ${n.error??""}`)),p(f,l)},C=f=>{var l=Ge(),y=x(S(l),2),g=b(y,!0);_(y),R(k=>j(g,k),[()=>JSON.stringify(n.data,null,2)]),p(f,l)};V(a,f=>{n.error?f(i):f(C,!1)},!0)}p(r,u)};V(v,r=>{n.loading?r(m):r(h,!1)})}_(c),_(s),p(e,s),tt()}var Ye=A('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function Ze(e){let t=O(0);function o(i){console.log(i)}var n=Ye(),s=x(b(n),2);ze(s,{random:o,get value(){return d(t)},set value(i){P(t,i,!0)}});var c=x(s,2);ue(c);var v=x(c,2);pe(v);var m=x(v,2);fe(m);var h=x(m,2);xe(h);var r=x(h,2);we(r,{});var u=x(r,2);Qe(u,{});var a=x(u,2);Se(a),_(n),p(e,n)}function oa(e){Ze(e)}export{oa as component};
