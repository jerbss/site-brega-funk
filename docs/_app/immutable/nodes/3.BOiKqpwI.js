import"../chunks/Bzak7iHL.js";import{I as q,J as _t,R as it,aS as jt,H as Ft,N as Pt,O as qt,aT as It,M as Nt,T as wt,a9 as Lt,a8 as yt,a4 as xt,x as Ut,ae as zt,ad as Gt,Q as Jt,V as T,X as v,ai as x,Z as _,_ as b,am as D,al as E,ao as Vt,W as O,n as d,an as I,U as $,u as K,Y as tt,F as pt,v as P,ak as N,az as Qt,aU as Yt,r as Zt}from"../chunks/D-LEvHX2.js";import{i as Ht,a as R,d as Wt}from"../chunks/D8n1WcDg.js";import{e as Q,i as Y,b as Xt,s as Kt,c as $t,d as te}from"../chunks/BQdEpx3j.js";import{c as ut,b as ee,i as V}from"../chunks/BbP9FdZf.js";import{s as mt,p as F}from"../chunks/CdFUhNF-.js";import{s as Tt}from"../chunks/CYx8mrRR.js";import{h as Ct,c as ae}from"../chunks/BcDov4J8.js";import{b as oe}from"../chunks/DY1x_IMO.js";function vt(e,t,n,o,s,c){let p=q;q&&_t();var m,h,r=null;q&&it.nodeType===jt&&(r=it,_t());var u=q?it:e,a;Ft(()=>{const i=t()||null;var C=i==="svg"?It:null;i!==m&&(a&&(i===null?zt(a,()=>{a=null,h=null}):i===h?Gt(a):Jt(a)),i&&i!==h&&(a=qt(()=>{if(r=q?r:C?document.createElementNS(C,i):document.createElement(i),Nt(r,r),o){q&&Ht(i)&&r.append(document.createComment(""));var f=q?wt(r):r.appendChild(Lt());q&&(f===null?yt(!1):xt(f)),o(r,f)}Ut.nodes_end=r,u.before(r)})),m=i,m&&(h=m))},Pt),p&&(yt(!0),xt(u))}var kt={},dt={},ct=34,X=10,lt=13;function Et(e){return new Function("d","return {"+e.map(function(t,n){return JSON.stringify(t)+": d["+n+'] || ""'}).join(",")+"}")}function ne(e,t){var n=Et(e);return function(o,s){return t(n(o),s,e)}}function At(e){var t=Object.create(null),n=[];return e.forEach(function(o){for(var s in o)s in t||n.push(t[s]=s)}),n}function M(e,t){var n=e+"",o=n.length;return o<t?new Array(t-o+1).join(0)+n:n}function re(e){return e<0?"-"+M(-e,6):e>9999?"+"+M(e,6):M(e,4)}function se(e){var t=e.getUTCHours(),n=e.getUTCMinutes(),o=e.getUTCSeconds(),s=e.getUTCMilliseconds();return isNaN(e)?"Invalid Date":re(e.getUTCFullYear())+"-"+M(e.getUTCMonth()+1,2)+"-"+M(e.getUTCDate(),2)+(s?"T"+M(t,2)+":"+M(n,2)+":"+M(o,2)+"."+M(s,3)+"Z":o?"T"+M(t,2)+":"+M(n,2)+":"+M(o,2)+"Z":n||t?"T"+M(t,2)+":"+M(n,2)+"Z":"")}function ie(e){var t=new RegExp('["'+e+`
\r]`),n=e.charCodeAt(0);function o(a,i){var C,f,l=s(a,function(y,g){if(C)return C(y,g-1);f=y,C=i?ne(y,i):Et(y)});return l.columns=f||[],l}function s(a,i){var C=[],f=a.length,l=0,y=0,g,k=f<=0,A=!1;a.charCodeAt(f-1)===X&&--f,a.charCodeAt(f-1)===lt&&--f;function B(){if(k)return dt;if(A)return A=!1,kt;var L,j=l,S;if(a.charCodeAt(j)===ct){for(;l++<f&&a.charCodeAt(l)!==ct||a.charCodeAt(++l)===ct;);return(L=l)>=f?k=!0:(S=a.charCodeAt(l++))===X?A=!0:S===lt&&(A=!0,a.charCodeAt(l)===X&&++l),a.slice(j+1,L-1).replace(/""/g,'"')}for(;l<f;){if((S=a.charCodeAt(L=l++))===X)A=!0;else if(S===lt)A=!0,a.charCodeAt(l)===X&&++l;else if(S!==n)continue;return a.slice(j,L)}return k=!0,a.slice(j,f)}for(;(g=B())!==dt;){for(var w=[];g!==kt&&g!==dt;)w.push(g),g=B();i&&(w=i(w,y++))==null||C.push(w)}return C}function c(a,i){return a.map(function(C){return i.map(function(f){return u(C[f])}).join(e)})}function p(a,i){return i==null&&(i=At(a)),[i.map(u).join(e)].concat(c(a,i)).join(`
`)}function m(a,i){return i==null&&(i=At(a)),c(a,i).join(`
`)}function h(a){return a.map(r).join(`
`)}function r(a){return a.map(u).join(e)}function u(a){return a==null?"":a instanceof Date?se(a):t.test(a+="")?'"'+a.replace(/"/g,'""')+'"':a}return{parse:o,parseRows:s,format:p,formatBody:m,formatRows:h,formatRow:r,formatValue:u}}var de=ie(","),ce=de.parse,le=T('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p></section>');function ue(e){var t=le();v(e,t)}var me=T('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function ve(e){var t=me();v(e,t)}var pe=T('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function fe(e){const t=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var n=pe(),o=x(_(n),2);Q(o,17,()=>t,Y,(s,c)=>{let p=()=>d(c).tag,m=()=>d(c).text;var h=D(),r=E(h);vt(r,p,!1,(u,a)=>{var i=Vt();O(()=>R(i,m())),v(a,i)}),v(s,h)}),b(n),v(e,n)}var ge=T("<p> </p>");function he(e,t){var n=ge(),o=_(n);b(n),O(()=>R(o,`I am component A and my favorite number is ${t.number??""}.`)),v(e,n)}var be=T("<p> </p>");function _e(e,t){var n=be(),o=_(n);b(n),O(()=>R(o,`I am component B and my name is ${t.name??""}.`)),v(e,n)}var ye=T('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function xe(e){const t={A:he,B:_e},n=[{component:"A",number:42},{component:"B",name:"Russell"}];var o=ye(),s=x(_(o),2);Q(s,17,()=>n,Y,(c,p)=>{const m=I(()=>t[d(p).component]);var h=D(),r=E(h);ut(r,()=>d(m),(u,a)=>{a(u,mt(()=>d(p)))}),v(c,h)}),b(o),v(e,o)}var Ce=T("<div><!></div>");function ke(e,t){$(t,!0);let n=F(t,"root",3,null),o=F(t,"top",3,0),s=F(t,"bottom",3,0),c=F(t,"increments",3,100),p=F(t,"value",15,void 0),m=[],h=[],r=[],u=[],a;function i(){let g=0,k=0;for(let A=0;A<m.length;A++)m[A]>g&&(g=m[A],k=A);g>0?p(k):p(void 0)}function C(g,k){const A=Z=>{Z[0].isIntersecting;const et=Z[0].intersectionRatio;m[k]=et,i()},B=o()?o()*-1:0,w=s()?s()*-1:0,L=`${B}px 0px ${w}px 0px`,j={root:n(),rootMargin:L,threshold:h};u[k]&&u[k].disconnect();const S=new IntersectionObserver(A,j);S.observe(g),u[k]=S}function f(){r.length&&r.forEach(C)}K(()=>{for(let g=0;g<c()+1;g++)h.push(g/c());r=a.querySelectorAll(":scope > *:not(iframe)"),f()}),K(()=>{o(),s(),f()});var l=Ce(),y=_(l);Tt(y,()=>t.children??pt),b(l),ee(l,g=>a=g,()=>a),v(e,l),tt()}var Ae=T('<div><p class="svelte-1sxgmm9"> </p></div>'),Te=T('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function Ee(e){let t=N(void 0);var n=Te(),o=_(n),s=x(_(o)),c=_(s,!0);b(s),b(o);var p=x(o,4);ke(p,{get value(){return d(t)},set value(m){P(t,m,!0)},children:(m,h)=>{var r=D(),u=E(r);Q(u,16,()=>[0,1,2,3,4],Y,(a,i,C)=>{const f=I(()=>d(t)===C);var l=Ae();let y;var g=_(l),k=_(g,!0);b(g),b(l),O(A=>{y=Xt(l,1,"step svelte-1sxgmm9",null,y,A),R(k,i)},[()=>({active:d(f)})]),v(a,l)}),v(m,r)},$$slots:{default:!0}}),Qt(2),b(n),O(()=>R(c,d(t)||"-")),v(e,n)}const Se=`{
	"meta": {
		...
		},
		{
			...
			"nodes": [
				...
				},
				{
					"type": "Text",
					"value": {
						"text": "A concentração do público nos estados vizinhos a Pernambuco mostra que o brega funk se consolidou como um movimento regional integrado antes de se nacionalizar. Essa força acumulada no Nordeste serviu de base para o ritmo ganhar espaço no Sul e no Sudeste com a expansão do streaming.",
						"speaker": "minji"
					}
				}
			]
...
`;var Me=T("<p><!></p>"),De=T("<section><!></section>");function Re(e,t){$(t,!0);let n=F(t,"components",19,()=>({})),o=F(t,"body",19,()=>[]);var s=D(),c=E(s);Q(c,17,o,Y,(p,m)=>{let h=()=>d(m).section,r=()=>d(m).content;const u=I(()=>h().toLowerCase().replace(/[^a-z0-9]/g,"")),a=I(()=>n()[h()]);var i=De(),C=_(i);{var f=y=>{var g=D(),k=E(g);ut(k,()=>d(a),(A,B)=>{B(A,mt(r))}),v(y,g)},l=y=>{var g=D(),k=E(g);Q(k,17,r,Y,(A,B,w,L)=>{let j=()=>d(B).type,S=()=>d(B).value;const Z=I(()=>n()[j()]),et=I(()=>typeof S()=="string");var ft=D(),St=E(ft);{var Mt=U=>{var H=D(),at=E(H);ut(at,()=>d(Z),(ot,nt)=>{nt(ot,mt(S))}),v(U,H)},Dt=U=>{var H=D(),at=E(H);{var ot=z=>{var G=Me(),rt=_(G);Ct(rt,S),b(G),v(z,G)},nt=z=>{var G=D(),rt=E(G);{var Rt=J=>{var W=D(),st=E(W);vt(st,j,!1,(gt,ht)=>{var bt=D(),Bt=E(bt);Ct(Bt,S),v(ht,bt)}),v(J,W)},Ot=J=>{var W=D(),st=E(W);vt(st,j,!1,(gt,ht)=>{$t(gt,()=>({...S()}))}),v(J,W)};V(rt,J=>{d(et)?J(Rt):J(Ot,!1)},!0)}v(z,G)};V(at,z=>{j()==="text"?z(ot):z(nt,!1)},!0)}v(U,H)};V(St,U=>{d(Z)?U(Mt):U(Dt,!1)})}v(A,ft)}),v(y,g)};V(C,y=>{d(a)?y(f):y(l,!1)})}b(i),O(()=>Kt(i,"id",d(u))),v(p,i)}),v(e,s),tt()}var Oe=T('<p> </p> <progress max="100"></progress>',1);function Be(e,t){let n=F(t,"label",3,"A"),o=F(t,"value",3,0);var s=Oe(),c=E(s),p=_(c,!0);b(c);var m=x(c,2);O(()=>{R(p,n()),te(m,o())}),v(e,s)}var je=T('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function Fe(e,t){$(t,!0);const{body:n}=ae,o={Test:Be};var s=je(),c=x(_(s),2),p=_(c),m=_(p,!0);b(p),b(c);var h=x(c,2);Re(h,{get components(){return o},get body(){return n}}),b(s),O(r=>R(m,r),[()=>Se.replace(/\t/g," ")]),v(e,s),tt()}const Pe=(e,t=pt)=>{var n=qe(),o=_(n),s=_(o,!0);b(o);var c=x(o,2),p=_(c,!0);b(c),b(n),O(()=>{R(s,t().name),R(p,t().age)}),v(e,n)};var qe=T('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),Ie=(e,t)=>Yt(t),Ne=(e,t)=>t.random(Math.floor(Math.random()*10)),we=T('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function Le(e,t){$(t,!0),F(t,"age",3,30);const n=[{name:"John",age:30},{name:"Jill",age:45}];let o=N(0),s=I(()=>d(o)*2),c=I(()=>d(o)*2),p=N(0);K(()=>{P(p,d(o)*2)});var m=we(),h=x(E(m),4);h.__click=[Ie,o];var r=x(h,2),u=_(r);b(r);var a=x(r,2),i=_(a);b(a);var C=x(a,2),f=_(C);b(C);var l=x(C,4),y=_(l);Tt(y,()=>t.children??pt),b(l);var g=x(l,4);g.__click=[Ne,t];var k=x(g,4);Q(k,21,()=>n,Y,(A,B)=>{Pe(A,()=>d(B))}),b(k),O(()=>{R(u,`${d(o)??""} doubled is ${d(s)??""} (derived)`),R(i,`${d(o)??""} doubled is ${d(c)??""} (derived by)`),R(f,`${d(o)??""} doubled is ${d(p)??""} ($effect)`)}),v(e,m),tt()}Wt(["click"]);const Ue=(e,t)=>{let n=N(Zt(e)),o=N(null),s=N(!0),c=N(void 0);const p=(r=!0)=>{P(s,r,!0),r===!0&&(P(c,null),P(o,null))},m=async()=>{try{const r=await fetch(d(n),t);if(!r.ok)throw new Error(`Unexpected error occurred (status ${r.status})`);let u;if(d(n).includes(".csv")){const a=await r.text();u=ce(a)}else u=await r.json();return[null,u]}catch(r){const{errorMessage:u="Unexpected error eccurred"}=r;return[u,null]}},h=async r=>{p(!0);const[u,a]=await m();if(r===d(n)){if(u){p(!1),P(c,u,!0);return}p(!1),P(o,a,!0)}};return K(()=>{h(d(n))}),{get data(){return d(o)},get loading(){return d(s)},get error(){return d(c)},get url(){return d(n)},set url(r){d(n)!==r&&P(n,r,!0)}}};var ze=T("<p>loading data...</p>"),Ge=T("<p> </p>"),Je=T("<p>data loaded</p> <pre> </pre>",1),Ve=T('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Qe(e,t){$(t,!0);const n=`${oe}/assets/demo/test.csv`,o=Ue(n);K(()=>{});var s=Ve(),c=x(_(s),2),p=_(c);{var m=r=>{var u=ze();v(r,u)},h=r=>{var u=D(),a=E(u);{var i=f=>{var l=Ge(),y=_(l);b(l),O(()=>R(y,`error: ${o.error??""}`)),v(f,l)},C=f=>{var l=Je(),y=x(E(l),2),g=_(y,!0);b(y),O(k=>R(g,k),[()=>JSON.stringify(o.data,null,2)]),v(f,l)};V(a,f=>{o.error?f(i):f(C,!1)},!0)}v(r,u)};V(p,r=>{o.loading?r(m):r(h,!1)})}b(c),b(s),v(e,s),tt()}var Ye=T('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function Ze(e){let t=N(0);function n(i){console.log(i)}var o=Ye(),s=x(_(o),2);Le(s,{random:n,get value(){return d(t)},set value(i){P(t,i,!0)}});var c=x(s,2);ue(c);var p=x(c,2);ve(p);var m=x(p,2);fe(m);var h=x(m,2);xe(h);var r=x(h,2);Fe(r,{});var u=x(r,2);Qe(u,{});var a=x(u,2);Ee(a),b(o),v(e,o)}function na(e){Ze(e)}export{na as component};
