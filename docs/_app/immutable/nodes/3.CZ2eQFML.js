import"../chunks/Bzak7iHL.js";import{I as F,J as bt,R as it,aS as qt,H as Pt,N as wt,O as Ft,aT as Nt,M as It,T as Ot,a9 as zt,a8 as xt,a4 as yt,x as Ut,ae as Lt,ad as Jt,Q as Vt,V as A,X as v,ai as y,Z as b,_,am as M,al as E,ao as Yt,W as j,n as d,an as N,U as K,u as X,Y as tt,F as pt,v as w,ak as I,aC as Gt,aU as Zt,r as Ht}from"../chunks/bbAY0-sh.js";import{i as Wt,a as D,d as Qt}from"../chunks/CqV49L9l.js";import{e as G,i as Z,b as $t,s as Xt,c as Kt,d as te}from"../chunks/agUzZV2y.js";import{c as ut,b as ee,i as Y}from"../chunks/B4gROAES.js";import{s as mt,p as P}from"../chunks/vhkXsIHq.js";import{s as At}from"../chunks/CbUN1PuN.js";import{h as Ct,c as ae}from"../chunks/DhK9rHuM.js";import{b as ne}from"../chunks/5NsDPjah.js";function vt(e,t,o,n,s,c){let p=F;F&&bt();var m,h,r=null;F&&it.nodeType===qt&&(r=it,bt());var u=F?it:e,a;Pt(()=>{const i=t()||null;var C=i==="svg"?Nt:null;i!==m&&(a&&(i===null?Lt(a,()=>{a=null,h=null}):i===h?Jt(a):Vt(a)),i&&i!==h&&(a=Ft(()=>{if(r=F?r:C?document.createElementNS(C,i):document.createElement(i),It(r,r),n){F&&Wt(i)&&r.append(document.createComment(""));var f=F?Ot(r):r.appendChild(zt());F&&(f===null?xt(!1):yt(f)),n(r,f)}Ut.nodes_end=r,u.before(r)})),m=i,m&&(h=m))},wt),p&&(xt(!0),yt(u))}var kt={},dt={},ct=34,$=10,lt=13;function Et(e){return new Function("d","return {"+e.map(function(t,o){return JSON.stringify(t)+": d["+o+'] || ""'}).join(",")+"}")}function oe(e,t){var o=Et(e);return function(n,s){return t(o(n),s,e)}}function Tt(e){var t=Object.create(null),o=[];return e.forEach(function(n){for(var s in n)s in t||o.push(t[s]=s)}),o}function R(e,t){var o=e+"",n=o.length;return n<t?new Array(t-n+1).join(0)+o:o}function re(e){return e<0?"-"+R(-e,6):e>9999?"+"+R(e,6):R(e,4)}function se(e){var t=e.getUTCHours(),o=e.getUTCMinutes(),n=e.getUTCSeconds(),s=e.getUTCMilliseconds();return isNaN(e)?"Invalid Date":re(e.getUTCFullYear())+"-"+R(e.getUTCMonth()+1,2)+"-"+R(e.getUTCDate(),2)+(s?"T"+R(t,2)+":"+R(o,2)+":"+R(n,2)+"."+R(s,3)+"Z":n?"T"+R(t,2)+":"+R(o,2)+":"+R(n,2)+"Z":o||t?"T"+R(t,2)+":"+R(o,2)+"Z":"")}function ie(e){var t=new RegExp('["'+e+`
\r]`),o=e.charCodeAt(0);function n(a,i){var C,f,l=s(a,function(x,g){if(C)return C(x,g-1);f=x,C=i?oe(x,i):Et(x)});return l.columns=f||[],l}function s(a,i){var C=[],f=a.length,l=0,x=0,g,k=f<=0,T=!1;a.charCodeAt(f-1)===$&&--f,a.charCodeAt(f-1)===lt&&--f;function B(){if(k)return dt;if(T)return T=!1,kt;var z,q=l,S;if(a.charCodeAt(q)===ct){for(;l++<f&&a.charCodeAt(l)!==ct||a.charCodeAt(++l)===ct;);return(z=l)>=f?k=!0:(S=a.charCodeAt(l++))===$?T=!0:S===lt&&(T=!0,a.charCodeAt(l)===$&&++l),a.slice(q+1,z-1).replace(/""/g,'"')}for(;l<f;){if((S=a.charCodeAt(z=l++))===$)T=!0;else if(S===lt)T=!0,a.charCodeAt(l)===$&&++l;else if(S!==o)continue;return a.slice(q,z)}return k=!0,a.slice(q,f)}for(;(g=B())!==dt;){for(var O=[];g!==kt&&g!==dt;)O.push(g),g=B();i&&(O=i(O,x++))==null||C.push(O)}return C}function c(a,i){return a.map(function(C){return i.map(function(f){return u(C[f])}).join(e)})}function p(a,i){return i==null&&(i=Tt(a)),[i.map(u).join(e)].concat(c(a,i)).join(`
`)}function m(a,i){return i==null&&(i=Tt(a)),c(a,i).join(`
`)}function h(a){return a.map(r).join(`
`)}function r(a){return a.map(u).join(e)}function u(a){return a==null?"":a instanceof Date?se(a):t.test(a+="")?'"'+a.replace(/"/g,'""')+'"':a}return{parse:n,parseRows:s,format:p,formatBody:m,formatRows:h,formatRow:r,formatValue:u}}var de=ie(","),ce=de.parse,le=A('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p></section>');function ue(e){var t=le();v(e,t)}var me=A('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function ve(e){var t=me();v(e,t)}var pe=A('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function fe(e){const t=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var o=pe(),n=y(b(o),2);G(n,17,()=>t,Z,(s,c)=>{let p=()=>d(c).tag,m=()=>d(c).text;var h=M(),r=E(h);vt(r,p,!1,(u,a)=>{var i=Yt();j(()=>D(i,m())),v(a,i)}),v(s,h)}),_(o),v(e,o)}var ge=A("<p> </p>");function he(e,t){var o=ge(),n=b(o);_(o),j(()=>D(n,`I am component A and my favorite number is ${t.number??""}.`)),v(e,o)}var _e=A("<p> </p>");function be(e,t){var o=_e(),n=b(o);_(o),j(()=>D(n,`I am component B and my name is ${t.name??""}.`)),v(e,o)}var xe=A('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function ye(e){const t={A:he,B:be},o=[{component:"A",number:42},{component:"B",name:"Russell"}];var n=xe(),s=y(b(n),2);G(s,17,()=>o,Z,(c,p)=>{const m=N(()=>t[d(p).component]);var h=M(),r=E(h);ut(r,()=>d(m),(u,a)=>{a(u,mt(()=>d(p)))}),v(c,h)}),_(n),v(e,n)}var Ce=A("<div><!></div>");function ke(e,t){K(t,!0);let o=P(t,"root",3,null),n=P(t,"top",3,0),s=P(t,"bottom",3,0),c=P(t,"increments",3,100),p=P(t,"value",15,void 0),m=[],h=[],r=[],u=[],a;function i(){let g=0,k=0;for(let T=0;T<m.length;T++)m[T]>g&&(g=m[T],k=T);g>0?p(k):p(void 0)}function C(g,k){const T=H=>{H[0].isIntersecting;const et=H[0].intersectionRatio;m[k]=et,i()},B=n()?n()*-1:0,O=s()?s()*-1:0,z=`${B}px 0px ${O}px 0px`,q={root:o(),rootMargin:z,threshold:h};u[k]&&u[k].disconnect();const S=new IntersectionObserver(T,q);S.observe(g),u[k]=S}function f(){r.length&&r.forEach(C)}X(()=>{for(let g=0;g<c()+1;g++)h.push(g/c());r=a.querySelectorAll(":scope > *:not(iframe)"),f()}),X(()=>{n(),s(),f()});var l=Ce(),x=b(l);At(x,()=>t.children??pt),_(l),ee(l,g=>a=g,()=>a),v(e,l),tt()}var Te=A('<div><p class="svelte-1sxgmm9"> </p></div>'),Ae=A('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function Ee(e){let t=I(void 0);var o=Ae(),n=b(o),s=y(b(n)),c=b(s,!0);_(s),_(n);var p=y(n,4);ke(p,{get value(){return d(t)},set value(m){w(t,m,!0)},children:(m,h)=>{var r=M(),u=E(r);G(u,16,()=>[0,1,2,3,4],Z,(a,i,C)=>{const f=N(()=>d(t)===C);var l=Te();let x;var g=b(l),k=b(g,!0);_(g),_(l),j(T=>{x=$t(l,1,"step svelte-1sxgmm9",null,x,T),D(k,i)},[()=>({active:d(f)})]),v(a,l)}),v(m,r)},$$slots:{default:!0}}),Gt(2),_(o),j(()=>D(c,d(t)||"-")),v(e,o)}const Se=`{
	"meta": {
			...
			"nodes": [
				{
					"type": "Text",
					"value": {
						"text": "Em janeiro de 2018, três adolescentes de Prazeres, periferia de Jaboatão dos Guararapes (PE), gravaram um videoclipe caseiro usando a câmera de um celular emprestado. Com um orçamento de apenas R$ 40, Paloma Roberta Silva Santos (MC Loma) e as irmãs Mirella e Mariely Santos (as Gêmeas Lacração) deram vida a 'Envolvimento'.",
						"speaker": "eunice"
					}
				},
				{
					"type": "Text",
					"value": {
						"text": "Sem contrato com grandes gravadoras, sem assessoria de imprensa e sem qualquer execução nas rádios tradicionais do eixo Rio-São Paulo, o vídeo amador viralizou no YouTube. Repercutido por influenciadores e estrelas da música nacional, o hit caseiro alcançou o topo do ranking diário nacional do Spotify em poucas semanas. Era o início de uma nova dinâmica no pop brasileiro.",
						"speaker": "minji"
					}
				},
				{
					"type": "Text",
					"value": {
						"text": "A escalada meteórica de Loma não foi um meme isolado, mas a porta de entrada para o mainstream de um ritmo que vinha sendo cozinhado há anos nas periferias de Pernambuco: o Brega Funk. O sucesso de 'Envolvimento' inaugurou um modelo em que a ascensão musical passou a ignorar os intermediários tradicionais da indústria fonográfica, estruturando-se inteiramente a partir da viralização orgânica nas redes, de coreografias replicáveis e da economia da atenção.",
						"speaker": "eunice"
					}
				}
			]
...
}`;var Re=A("<p><!></p>"),Me=A("<section><!></section>");function De(e,t){K(t,!0);let o=P(t,"components",19,()=>({})),n=P(t,"body",19,()=>[]);var s=M(),c=E(s);G(c,17,n,Z,(p,m)=>{let h=()=>d(m).section,r=()=>d(m).content;const u=N(()=>h().toLowerCase().replace(/[^a-z0-9]/g,"")),a=N(()=>o()[h()]);var i=Me(),C=b(i);{var f=x=>{var g=M(),k=E(g);ut(k,()=>d(a),(T,B)=>{B(T,mt(r))}),v(x,g)},l=x=>{var g=M(),k=E(g);G(k,17,r,Z,(T,B,O,z)=>{let q=()=>d(B).type,S=()=>d(B).value;const H=N(()=>o()[q()]),et=N(()=>typeof S()=="string");var ft=M(),St=E(ft);{var Rt=U=>{var W=M(),at=E(W);ut(at,()=>d(H),(nt,ot)=>{ot(nt,mt(S))}),v(U,W)},Mt=U=>{var W=M(),at=E(W);{var nt=L=>{var J=Re(),rt=b(J);Ct(rt,S),_(J),v(L,J)},ot=L=>{var J=M(),rt=E(J);{var Dt=V=>{var Q=M(),st=E(Q);vt(st,q,!1,(gt,ht)=>{var _t=M(),Bt=E(_t);Ct(Bt,S),v(ht,_t)}),v(V,Q)},jt=V=>{var Q=M(),st=E(Q);vt(st,q,!1,(gt,ht)=>{Kt(gt,()=>({...S()}))}),v(V,Q)};Y(rt,V=>{d(et)?V(Dt):V(jt,!1)},!0)}v(L,J)};Y(at,L=>{q()==="text"?L(nt):L(ot,!1)},!0)}v(U,W)};Y(St,U=>{d(H)?U(Rt):U(Mt,!1)})}v(T,ft)}),v(x,g)};Y(C,x=>{d(a)?x(f):x(l,!1)})}_(i),j(()=>Xt(i,"id",d(u))),v(p,i)}),v(e,s),tt()}var je=A('<p> </p> <progress max="100"></progress>',1);function Be(e,t){let o=P(t,"label",3,"A"),n=P(t,"value",3,0);var s=je(),c=E(s),p=b(c,!0);_(c);var m=y(c,2);j(()=>{D(p,o()),te(m,n())}),v(e,s)}var qe=A('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function Pe(e,t){K(t,!0);const{body:o}=ae,n={Test:Be};var s=qe(),c=y(b(s),2),p=b(c),m=b(p,!0);_(p),_(c);var h=y(c,2);De(h,{get components(){return n},get body(){return o}}),_(s),j(r=>D(m,r),[()=>Se.replace(/\t/g," ")]),v(e,s),tt()}const we=(e,t=pt)=>{var o=Fe(),n=b(o),s=b(n,!0);_(n);var c=y(n,2),p=b(c,!0);_(c),_(o),j(()=>{D(s,t().name),D(p,t().age)}),v(e,o)};var Fe=A('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),Ne=(e,t)=>Zt(t),Ie=(e,t)=>t.random(Math.floor(Math.random()*10)),Oe=A('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function ze(e,t){K(t,!0),P(t,"age",3,30);const o=[{name:"John",age:30},{name:"Jill",age:45}];let n=I(0),s=N(()=>d(n)*2),c=N(()=>d(n)*2),p=I(0);X(()=>{w(p,d(n)*2)});var m=Oe(),h=y(E(m),4);h.__click=[Ne,n];var r=y(h,2),u=b(r);_(r);var a=y(r,2),i=b(a);_(a);var C=y(a,2),f=b(C);_(C);var l=y(C,4),x=b(l);At(x,()=>t.children??pt),_(l);var g=y(l,4);g.__click=[Ie,t];var k=y(g,4);G(k,21,()=>o,Z,(T,B)=>{we(T,()=>d(B))}),_(k),j(()=>{D(u,`${d(n)??""} doubled is ${d(s)??""} (derived)`),D(i,`${d(n)??""} doubled is ${d(c)??""} (derived by)`),D(f,`${d(n)??""} doubled is ${d(p)??""} ($effect)`)}),v(e,m),tt()}Qt(["click"]);const Ue=(e,t)=>{let o=I(Ht(e)),n=I(null),s=I(!0),c=I(void 0);const p=(r=!0)=>{w(s,r,!0),r===!0&&(w(c,null),w(n,null))},m=async()=>{try{const r=await fetch(d(o),t);if(!r.ok)throw new Error(`Unexpected error occurred (status ${r.status})`);let u;if(d(o).includes(".csv")){const a=await r.text();u=ce(a)}else u=await r.json();return[null,u]}catch(r){const{errorMessage:u="Unexpected error eccurred"}=r;return[u,null]}},h=async r=>{p(!0);const[u,a]=await m();if(r===d(o)){if(u){p(!1),w(c,u,!0);return}p(!1),w(n,a,!0)}};return X(()=>{h(d(o))}),{get data(){return d(n)},get loading(){return d(s)},get error(){return d(c)},get url(){return d(o)},set url(r){d(o)!==r&&w(o,r,!0)}}};var Le=A("<p>loading data...</p>"),Je=A("<p> </p>"),Ve=A("<p>data loaded</p> <pre> </pre>",1),Ye=A('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Ge(e,t){K(t,!0);const o=`${ne}/assets/demo/test.csv`,n=Ue(o);X(()=>{});var s=Ye(),c=y(b(s),2),p=b(c);{var m=r=>{var u=Le();v(r,u)},h=r=>{var u=M(),a=E(u);{var i=f=>{var l=Je(),x=b(l);_(l),j(()=>D(x,`error: ${n.error??""}`)),v(f,l)},C=f=>{var l=Ve(),x=y(E(l),2),g=b(x,!0);_(x),j(k=>D(g,k),[()=>JSON.stringify(n.data,null,2)]),v(f,l)};Y(a,f=>{n.error?f(i):f(C,!1)},!0)}v(r,u)};Y(p,r=>{n.loading?r(m):r(h,!1)})}_(c),_(s),v(e,s),tt()}var Ze=A('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function He(e){let t=I(0);function o(i){console.log(i)}var n=Ze(),s=y(b(n),2);ze(s,{random:o,get value(){return d(t)},set value(i){w(t,i,!0)}});var c=y(s,2);ue(c);var p=y(c,2);ve(p);var m=y(p,2);fe(m);var h=y(m,2);ye(h);var r=y(h,2);Pe(r,{});var u=y(r,2);Ge(u,{});var a=y(u,2);Ee(a),_(n),v(e,n)}function oa(e){He(e)}export{oa as component};
