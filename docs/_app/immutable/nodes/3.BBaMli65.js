...
import { i as Ht, a as R, d as Wt } from "../chunks/D8n1WcDg.js";
import {
	e as Y,
	i as Q,
	b as Xt,
...
import { c as ut, b as ee, i as V } from "../chunks/BbP9FdZf.js";
import { s as mt, p as q } from "../chunks/CdFUhNF-.js";
import { s as At } from "../chunks/CYx8mrRR.js";
import { h as Ct, c as ae } from "../chunks/Cq9w4BsX.js";
import { b as re } from "../chunks/DaB-RJFI.js";
				...
				(a = Pt(() => {
					if (
						((n = P
							? n
							: C
								? document.createElementNS(C, i)
								: document.createElement(i)),
						It(n, n),
						r)
					) {
						P && Ht(i) && n.append(document.createComment(""));
						var f = P ? Nt(n) : n.appendChild(Ut());
						(P && (f === null ? yt(!1) : xt(f)), r(n, f));
					}
					((zt.nodes_end = n), u.before(n));
				})),
			(m = i),
			m && (h = m));
	}, Ot),
...
function Tt(e) {
	...
	return (
		e.forEach(function (r) {
			for (var s in r) s in t || o.push((t[s] = s));
		}),
		o
	);
}
function M(e, t) {
	var o = e + "",
		r = o.length;
	return r < t ? new Array(t - r + 1).join(0) + o : o;
}
function ne(e) {
	return e < 0 ? "-" + M(-e, 6) : e > 9999 ? "+" + M(e, 6) : M(e, 4);
}
function se(e) {
	var t = e.getUTCHours(),
		o = e.getUTCMinutes(),
	...
	return isNaN(e)
		...
		: ne(e.getUTCFullYear()) +
				...
				M(e.getUTCDate(), 2) +
				(s
					? "T" + M(t, 2) + ":" + M(o, 2) + ":" + M(r, 2) + "." + M(s, 3) + "Z"
					: r
						? "T" + M(t, 2) + ":" + M(o, 2) + ":" + M(r, 2) + "Z"
						: o || t
							? "T" + M(t, 2) + ":" + M(o, 2) + "Z"
							: "");
}
...
\r]`
	...
	function s(a, i) {
		var C = [],
			...
			k = f <= 0,
			T = !1;
		(a.charCodeAt(f - 1) === X && --f, a.charCodeAt(f - 1) === lt && --f);
		function B() {
			if (k) return dt;
			if (T) return ((T = !1), kt);
			var U,
				F = l,
				E;
			if (a.charCodeAt(F) === ct) {
				for (
					;
					(l++ < f && a.charCodeAt(l) !== ct) || a.charCodeAt(++l) === ct;
				...
				return (
					(U = l) >= f
						...
						: (E = a.charCodeAt(l++)) === X
							? (T = !0)
							: E === lt && ((T = !0), a.charCodeAt(l) === X && ++l),
					a.slice(F + 1, U - 1).replace(/""/g, '"')
				);
			}
			for (; l < f; ) {
				if ((E = a.charCodeAt((U = l++))) === X) T = !0;
				else if (E === lt) ((T = !0), a.charCodeAt(l) === X && ++l);
				else if (E !== o) continue;
				return a.slice(F, U);
			}
			return ((k = !0), a.slice(F, f));
		}
		for (; (g = B()) !== dt; ) {
			for (var N = []; g !== kt && g !== dt; ) (N.push(g), (g = B()));
			(i && (N = i(N, y++)) == null) || C.push(N);
		}
		return C;
	}
	function c(a, i) {
	...
	function v(a, i) {
		return (
			i == null && (i = Tt(a)),
			[i.map(u).join(e)].concat(c(a, i)).join(`
`)
		);
	}
	function m(a, i) {
...
var de = ie(","),
	ce = de.parse,
	le = A(
		'<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p></section>'
	);
function ue(e) {
	var t = le();
	p(e, t);
...
var me = A(
	'<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>'
);
function pe(e) {
	var t = me();
	p(e, t);
...
var ve = A(
	'<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>'
);
function fe(e) {
	const t = [
...
function he(e, t) {
	...
	(b(o),
		j(() =>
			R(r, `I am component A and my favorite number is ${t.number ?? ""}.`)
		),
		p(e, o));
}
var be = A("<p> </p>");
function _e(e, t) {
	var o = be(),
		r = _(o);
	(b(o),
		j(() => R(r, `I am component B and my name is ${t.name ?? ""}.`)),
		p(e, o));
}
var ye = A(
	'<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>'
);
function xe(e) {
	const t = { A: he, B: _e },
		o = [
...
function ke(e, t) {
	$(t, !0);
	let o = q(t, "root", 3, null),
		r = q(t, "top", 3, 0),
		s = q(t, "bottom", 3, 0),
		c = q(t, "increments", 3, 100),
		v = q(t, "value", 15, void 0),
		m = [],
		h = [],
		n = [],
		u = [],
	...
	function i() {
		let g = 0,
			k = 0;
		for (let T = 0; T < m.length; T++) m[T] > g && ((g = m[T]), (k = T));
		g > 0 ? v(k) : v(void 0);
	}
	function C(g, k) {
		const T = (Z) => {
				Z[0].isIntersecting;
				const et = Z[0].intersectionRatio;
				((m[k] = et), i());
			},
			B = r() ? r() * -1 : 0,
			N = s() ? s() * -1 : 0,
			U = `${B}px 0px ${N}px 0px`,
			F = { root: o(), rootMargin: U, threshold: h };
		u[k] && u[k].disconnect();
		const E = new IntersectionObserver(T, F);
		(E.observe(g), (u[k] = E));
	}
	function f() {
	...
	(K(() => {
		for (let g = 0; g < c() + 1; g++) h.push(g / c());
		((n = a.querySelectorAll(":scope > *:not(iframe)")), f());
	}),
		K(() => {
			(r(), s(), f());
		}));
...
var Te = A('<div><p class="svelte-1sxgmm9"> </p></div>'),
	Ae = A(
		'<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>'
	);
function Se(e) {
	let t = I(void 0);
	var o = Ae(),
			...
			(Y(
				...
				(a, i, C) => {
					...
					(b(g),
						...
						j(
							(T) => {
								((y = Xt(l, 1, "step svelte-1sxgmm9", null, y, T)), R(k, i));
							},
							[() => ({ active: d(f) })]
						),
						p(a, l));
...
var Me = A("<p><!></p>"),
	De = A("<section><!></section>");
function Re(e, t) {
	$(t, !0);
	let o = q(t, "components", 19, () => ({})),
		r = q(t, "body", 19, () => []);
	var s = D(),
		c = S(s);
	(Y(c, 17, r, Q, (v, m) => {
		...
		(b(i), j(() => Kt(i, "id", d(u))), p(v, i));
	}),
		p(e, s),
		tt());
}
var je = A('<p> </p> <progress max="100"></progress>', 1);
function Be(e, t) {
	let o = q(t, "label", 3, "A"),
		r = q(t, "value", 3, 0);
	var s = je(),
...
var Fe = A(
	'<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>'
);
function qe(e, t) {
	$(t, !0);
	const { body: o } = ae,
...
const Oe = (e, t = vt) => {
	...
	(b(c),
		b(o),
		j(() => {
			(R(s, t().name), R(v, t().age));
		}),
		p(e, o));
};
var Pe = A(
		'<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'
	),
	we = (e, t) => Qt(t),
	Ie = (e, t) => t.random(Math.floor(Math.random() * 10)),
	Ne = A(
		'<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',
		1
	);
function Ue(e, t) {
	($(t, !0), q(t, "age", 3, 30));
	...
	(Y(
		...
		b(k),
		j(() => {
			(R(u, `${d(r) ?? ""} doubled is ${d(s) ?? ""} (derived)`),
				R(i, `${d(r) ?? ""} doubled is ${d(c) ?? ""} (derived by)`),
				R(f, `${d(r) ?? ""} doubled is ${d(v) ?? ""} ($effect)`));
		}),
		p(e, m),
		tt());
}
...
const ze = (e, t) => {
	let o = I(Zt(e)),
		...
		c = I(void 0);
	const v = (n = !0) => {
			(O(s, n, !0), n === !0 && (O(c, null), O(r, null)));
		},
		m = async () => {
			try {
				const n = await fetch(d(o), t);
				if (!n.ok)
					throw new Error(`Unexpected error occurred (status ${n.status})`);
				let u;
				if (d(o).includes(".csv")) {
				...
				const { errorMessage: u = "Unexpected error eccurred" } = n;
				return [u, null];
			}
		},
		h = async (n) => {
...
var Le = A("<p>loading data...</p>"),
	Je = A("<p> </p>"),
	Ge = A("<p>data loaded</p> <pre> </pre>", 1),
	Ve = A(
		'<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>'
	);
function Ye(e, t) {
	$(t, !0);
	const o = `${re}/assets/demo/test.csv`,
		r = ze(o);
	K(() => {});
	var s = Ve(),
		c = x(_(s), 2),
					...
					var i = (f) => {
						...
						C = (f) => {
							var l = Ge(),
								...
								g = _(y, !0);
							(b(y),
								j((k) => R(g, k), [() => JSON.stringify(r.data, null, 2)]),
								p(f, l));
						};
					V(
						a,
...
var Qe = A(
	'<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>'
);
function Ze(e) {
	let t = I(0);
	function o(i) {
