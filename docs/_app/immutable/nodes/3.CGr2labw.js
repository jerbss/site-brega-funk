import"../chunks/Bzak7iHL.js";import{I as F,J as bt,R as it,aS as qt,H as Nt,N as wt,O as Ft,aT as Pt,M as It,T as Ot,a9 as zt,a8 as xt,a4 as yt,x as Ut,ae as Lt,ad as Jt,Q as Vt,V as A,X as p,ai as y,Z as b,_,am as R,al as E,ao as Yt,W as j,n as d,an as P,U as K,u as $,Y as tt,F as vt,v as w,ak as I,aC as Gt,aU as Zt,r as Ht}from"../chunks/bbAY0-sh.js";import{i as Wt,a as D,d as Qt}from"../chunks/CqV49L9l.js";import{e as G,i as Z,b as Xt,s as $t,c as Kt,d as te}from"../chunks/agUzZV2y.js";import{c as lt,b as ee,i as Y}from"../chunks/B4gROAES.js";import{s as mt,p as N}from"../chunks/vhkXsIHq.js";import{s as At}from"../chunks/CbUN1PuN.js";import{h as Ct,c as ae}from"../chunks/C6RIuPVz.js";import{b as ne}from"../chunks/3TIzdwon.js";function pt(e,t,o,n,s,c){let v=F;F&&bt();var m,h,r=null;F&&it.nodeType===qt&&(r=it,bt());var l=F?it:e,a;Nt(()=>{const i=t()||null;var C=i==="svg"?Pt:null;i!==m&&(a&&(i===null?Lt(a,()=>{a=null,h=null}):i===h?Jt(a):Vt(a)),i&&i!==h&&(a=Ft(()=>{if(r=F?r:C?document.createElementNS(C,i):document.createElement(i),It(r,r),n){F&&Wt(i)&&r.append(document.createComment(""));var f=F?Ot(r):r.appendChild(zt());F&&(f===null?xt(!1):yt(f)),n(r,f)}Ut.nodes_end=r,l.before(r)})),m=i,m&&(h=m))},wt),v&&(xt(!0),yt(l))}var kt={},dt={},ct=34,X=10,ut=13;function Et(e){return new Function("d","return {"+e.map(function(t,o){return JSON.stringify(t)+": d["+o+'] || ""'}).join(",")+"}")}function oe(e,t){var o=Et(e);return function(n,s){return t(o(n),s,e)}}function Tt(e){var t=Object.create(null),o=[];return e.forEach(function(n){for(var s in n)s in t||o.push(t[s]=s)}),o}function M(e,t){var o=e+"",n=o.length;return n<t?new Array(t-n+1).join(0)+o:o}function re(e){return e<0?"-"+M(-e,6):e>9999?"+"+M(e,6):M(e,4)}function se(e){var t=e.getUTCHours(),o=e.getUTCMinutes(),n=e.getUTCSeconds(),s=e.getUTCMilliseconds();return isNaN(e)?"Invalid Date":re(e.getUTCFullYear())+"-"+M(e.getUTCMonth()+1,2)+"-"+M(e.getUTCDate(),2)+(s?"T"+M(t,2)+":"+M(o,2)+":"+M(n,2)+"."+M(s,3)+"Z":n?"T"+M(t,2)+":"+M(o,2)+":"+M(n,2)+"Z":o||t?"T"+M(t,2)+":"+M(o,2)+"Z":"")}function ie(e){var t=new RegExp('["'+e+`
\r]`),o=e.charCodeAt(0);function n(a,i){var C,f,u=s(a,function(x,g){if(C)return C(x,g-1);f=x,C=i?oe(x,i):Et(x)});return u.columns=f||[],u}function s(a,i){var C=[],f=a.length,u=0,x=0,g,k=f<=0,T=!1;a.charCodeAt(f-1)===X&&--f,a.charCodeAt(f-1)===ut&&--f;function B(){if(k)return dt;if(T)return T=!1,kt;var z,q=u,S;if(a.charCodeAt(q)===ct){for(;u++<f&&a.charCodeAt(u)!==ct||a.charCodeAt(++u)===ct;);return(z=u)>=f?k=!0:(S=a.charCodeAt(u++))===X?T=!0:S===ut&&(T=!0,a.charCodeAt(u)===X&&++u),a.slice(q+1,z-1).replace(/""/g,'"')}for(;u<f;){if((S=a.charCodeAt(z=u++))===X)T=!0;else if(S===ut)T=!0,a.charCodeAt(u)===X&&++u;else if(S!==o)continue;return a.slice(q,z)}return k=!0,a.slice(q,f)}for(;(g=B())!==dt;){for(var O=[];g!==kt&&g!==dt;)O.push(g),g=B();i&&(O=i(O,x++))==null||C.push(O)}return C}function c(a,i){return a.map(function(C){return i.map(function(f){return l(C[f])}).join(e)})}function v(a,i){return i==null&&(i=Tt(a)),[i.map(l).join(e)].concat(c(a,i)).join(`
`)}function m(a,i){return i==null&&(i=Tt(a)),c(a,i).join(`
`)}function h(a){return a.map(r).join(`
`)}function r(a){return a.map(l).join(e)}function l(a){return a==null?"":a instanceof Date?se(a):t.test(a+="")?'"'+a.replace(/"/g,'""')+'"':a}return{parse:n,parseRows:s,format:v,formatBody:m,formatRows:h,formatRow:r,formatValue:l}}var de=ie(","),ce=de.parse,ue=A('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p></section>');function le(e){var t=ue();p(e,t)}var me=A('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function pe(e){var t=me();p(e,t)}var ve=A('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function fe(e){const t=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var o=ve(),n=y(b(o),2);G(n,17,()=>t,Z,(s,c)=>{let v=()=>d(c).tag,m=()=>d(c).text;var h=R(),r=E(h);pt(r,v,!1,(l,a)=>{var i=Yt();j(()=>D(i,m())),p(a,i)}),p(s,h)}),_(o),p(e,o)}var ge=A("<p> </p>");function he(e,t){var o=ge(),n=b(o);_(o),j(()=>D(n,`I am component A and my favorite number is ${t.number??""}.`)),p(e,o)}var _e=A("<p> </p>");function be(e,t){var o=_e(),n=b(o);_(o),j(()=>D(n,`I am component B and my name is ${t.name??""}.`)),p(e,o)}var xe=A('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function ye(e){const t={A:he,B:be},o=[{component:"A",number:42},{component:"B",name:"Russell"}];var n=xe(),s=y(b(n),2);G(s,17,()=>o,Z,(c,v)=>{const m=P(()=>t[d(v).component]);var h=R(),r=E(h);lt(r,()=>d(m),(l,a)=>{a(l,mt(()=>d(v)))}),p(c,h)}),_(n),p(e,n)}var Ce=A("<div><!></div>");function ke(e,t){K(t,!0);let o=N(t,"root",3,null),n=N(t,"top",3,0),s=N(t,"bottom",3,0),c=N(t,"increments",3,100),v=N(t,"value",15,void 0),m=[],h=[],r=[],l=[],a;function i(){let g=0,k=0;for(let T=0;T<m.length;T++)m[T]>g&&(g=m[T],k=T);g>0?v(k):v(void 0)}function C(g,k){const T=H=>{H[0].isIntersecting;const et=H[0].intersectionRatio;m[k]=et,i()},B=n()?n()*-1:0,O=s()?s()*-1:0,z=`${B}px 0px ${O}px 0px`,q={root:o(),rootMargin:z,threshold:h};l[k]&&l[k].disconnect();const S=new IntersectionObserver(T,q);S.observe(g),l[k]=S}function f(){r.length&&r.forEach(C)}$(()=>{for(let g=0;g<c()+1;g++)h.push(g/c());r=a.querySelectorAll(":scope > *:not(iframe)"),f()}),$(()=>{n(),s(),f()});var u=Ce(),x=b(u);At(x,()=>t.children??vt),_(u),ee(u,g=>a=g,()=>a),p(e,u),tt()}var Te=A('<div><p class="svelte-1sxgmm9"> </p></div>'),Ae=A('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function Ee(e){let t=I(void 0);var o=Ae(),n=b(o),s=y(b(n)),c=b(s,!0);_(s),_(n);var v=y(n,4);ke(v,{get value(){return d(t)},set value(m){w(t,m,!0)},children:(m,h)=>{var r=R(),l=E(r);G(l,16,()=>[0,1,2,3,4],Z,(a,i,C)=>{const f=P(()=>d(t)===C);var u=Te();let x;var g=b(u),k=b(g,!0);_(g),_(u),j(T=>{x=Xt(u,1,"step svelte-1sxgmm9",null,x,T),D(k,i)},[()=>({active:d(f)})]),p(a,u)}),p(m,r)},$$slots:{default:!0}}),Gt(2),_(o),j(()=>D(c,d(t)||"-")),p(e,o)}const Se=`{
	"meta": {
...
}`;var Me=A("<p><!></p>"),Re=A("<section><!></section>");function De(e,t){K(t,!0);let o=N(t,"components",19,()=>({})),n=N(t,"body",19,()=>[]);var s=R(),c=E(s);G(c,17,n,Z,(v,m)=>{let h=()=>d(m).section,r=()=>d(m).content;const l=P(()=>h().toLowerCase().replace(/[^a-z0-9]/g,"")),a=P(()=>o()[h()]);var i=Re(),C=b(i);{var f=x=>{var g=R(),k=E(g);lt(k,()=>d(a),(T,B)=>{B(T,mt(r))}),p(x,g)},u=x=>{var g=R(),k=E(g);G(k,17,r,Z,(T,B,O,z)=>{let q=()=>d(B).type,S=()=>d(B).value;const H=P(()=>o()[q()]),et=P(()=>typeof S()=="string");var ft=R(),St=E(ft);{var Mt=U=>{var W=R(),at=E(W);lt(at,()=>d(H),(nt,ot)=>{ot(nt,mt(S))}),p(U,W)},Rt=U=>{var W=R(),at=E(W);{var nt=L=>{var J=Me(),rt=b(J);Ct(rt,S),_(J),p(L,J)},ot=L=>{var J=R(),rt=E(J);{var Dt=V=>{var Q=R(),st=E(Q);pt(st,q,!1,(gt,ht)=>{var _t=R(),Bt=E(_t);Ct(Bt,S),p(ht,_t)}),p(V,Q)},jt=V=>{var Q=R(),st=E(Q);pt(st,q,!1,(gt,ht)=>{Kt(gt,()=>({...S()}))}),p(V,Q)};Y(rt,V=>{d(et)?V(Dt):V(jt,!1)},!0)}p(L,J)};Y(at,L=>{q()==="text"?L(nt):L(ot,!1)},!0)}p(U,W)};Y(St,U=>{d(H)?U(Mt):U(Rt,!1)})}p(T,ft)}),p(x,g)};Y(C,x=>{d(a)?x(f):x(u,!1)})}_(i),j(()=>$t(i,"id",d(l))),p(v,i)}),p(e,s),tt()}var je=A('<p> </p> <progress max="100"></progress>',1);function Be(e,t){let o=N(t,"label",3,"A"),n=N(t,"value",3,0);var s=je(),c=E(s),v=b(c,!0);_(c);var m=y(c,2);j(()=>{D(v,o()),te(m,n())}),p(e,s)}var qe=A('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function Ne(e,t){K(t,!0);const{body:o}=ae,n={Test:Be};var s=qe(),c=y(b(s),2),v=b(c),m=b(v,!0);_(v),_(c);var h=y(c,2);De(h,{get components(){return n},get body(){return o}}),_(s),j(r=>D(m,r),[()=>Se.replace(/\t/g," ")]),p(e,s),tt()}const we=(e,t=vt)=>{var o=Fe(),n=b(o),s=b(n,!0);_(n);var c=y(n,2),v=b(c,!0);_(c),_(o),j(()=>{D(s,t().name),D(v,t().age)}),p(e,o)};var Fe=A('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),Pe=(e,t)=>Zt(t),Ie=(e,t)=>t.random(Math.floor(Math.random()*10)),Oe=A('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function ze(e,t){K(t,!0),N(t,"age",3,30);const o=[{name:"John",age:30},{name:"Jill",age:45}];let n=I(0),s=P(()=>d(n)*2),c=P(()=>d(n)*2),v=I(0);$(()=>{w(v,d(n)*2)});var m=Oe(),h=y(E(m),4);h.__click=[Pe,n];var r=y(h,2),l=b(r);_(r);var a=y(r,2),i=b(a);_(a);var C=y(a,2),f=b(C);_(C);var u=y(C,4),x=b(u);At(x,()=>t.children??vt),_(u);var g=y(u,4);g.__click=[Ie,t];var k=y(g,4);G(k,21,()=>o,Z,(T,B)=>{we(T,()=>d(B))}),_(k),j(()=>{D(l,`${d(n)??""} doubled is ${d(s)??""} (derived)`),D(i,`${d(n)??""} doubled is ${d(c)??""} (derived by)`),D(f,`${d(n)??""} doubled is ${d(v)??""} ($effect)`)}),p(e,m),tt()}Qt(["click"]);const Ue=(e,t)=>{let o=I(Ht(e)),n=I(null),s=I(!0),c=I(void 0);const v=(r=!0)=>{w(s,r,!0),r===!0&&(w(c,null),w(n,null))},m=async()=>{try{const r=await fetch(d(o),t);if(!r.ok)throw new Error(`Unexpected error occurred (status ${r.status})`);let l;if(d(o).includes(".csv")){const a=await r.text();l=ce(a)}else l=await r.json();return[null,l]}catch(r){const{errorMessage:l="Unexpected error eccurred"}=r;return[l,null]}},h=async r=>{v(!0);const[l,a]=await m();if(r===d(o)){if(l){v(!1),w(c,l,!0);return}v(!1),w(n,a,!0)}};return $(()=>{h(d(o))}),{get data(){return d(n)},get loading(){return d(s)},get error(){return d(c)},get url(){return d(o)},set url(r){d(o)!==r&&w(o,r,!0)}}};var Le=A("<p>loading data...</p>"),Je=A("<p> </p>"),Ve=A("<p>data loaded</p> <pre> </pre>",1),Ye=A('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function Ge(e,t){K(t,!0);const o=`${ne}/assets/demo/test.csv`,n=Ue(o);$(()=>{});var s=Ye(),c=y(b(s),2),v=b(c);{var m=r=>{var l=Le();p(r,l)},h=r=>{var l=R(),a=E(l);{var i=f=>{var u=Je(),x=b(u);_(u),j(()=>D(x,`error: ${n.error??""}`)),p(f,u)},C=f=>{var u=Ve(),x=y(E(u),2),g=b(x,!0);_(x),j(k=>D(g,k),[()=>JSON.stringify(n.data,null,2)]),p(f,u)};Y(a,f=>{n.error?f(i):f(C,!1)},!0)}p(r,l)};Y(v,r=>{n.loading?r(m):r(h,!1)})}_(c),_(s),p(e,s),tt()}var Ze=A('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function He(e){let t=I(0);function o(i){console.log(i)}var n=Ze(),s=y(b(n),2);ze(s,{random:o,get value(){return d(t)},set value(i){w(t,i,!0)}});var c=y(s,2);le(c);var v=y(c,2);pe(v);var m=y(v,2);fe(m);var h=y(m,2);ye(h);var r=y(h,2);Ne(r,{});var l=y(r,2);Ge(l,{});var a=y(l,2);Ee(a),_(n),p(e,n)}function oa(e){He(e)}export{oa as component};
