# Análise Detalhada das Referências do *The Pudding*
...
O projeto `/ai` do *The Pudding* é um caso real de ensaio visual construído em parceria com o Claude. Algumas dicas valiosas que extraímos do código e da documentação de lá:
...
*   **Não.** A melhor prática para ensaios interativos (especialmente nos padrões do *The Pudding*) é a criação **centrada no design visual e no layout da informação**. 
*   Inicialmente, definiremos a **estrutura narrativa** (ex: o scrollytelling conterá 4 passos). O texto do artigo pode ser inserido temporariamente como *Lorem Ipsum* estilizado com alguns títulos reais (como o título e a provocação inicial). 
