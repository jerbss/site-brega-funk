<script>
	...
	let { url, title, nodeId, sectionId, format = "landscape" } = $props();
...
<style>
	...
	.volume-btn:hover {
		background: var(--color-bg, #05020c);
		border-color: var(--color-link-hover, #d4ff00);
		color: var(--color-link-hover, #d4ff00);
